...
app.get('/api/verify', async (req, res) => {
	let twitchOAuthUrl = "https://id.twitch.tv/oauth2/authorize" + "?client_id=" + client_id + "&redirect_uri=" + decodeURIComponent(redirect_uri) + "&response_type=code&scope=channel:read:redemptions" + "&state=" + req.sessionID;
